...
ActiveRecord::Schema.define(version: 2022_05_02_105825) do
  ...
  create_table "likes", id: :uuid, default: -> { "gen_random_uuid()" }, comment: "いいね", force: :cascade do |t|
    ...
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["from_account_id", "to_account_id"], name: "index_likes_on_from_account_id_and_to_account_id", unique: true
